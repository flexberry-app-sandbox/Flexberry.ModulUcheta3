...
namespace IIS.Modul_ucheta
{
    ...
    public class ОказанныеУслуги : ICSSoft.STORMNET.DataObject
    {
        ...
        /// Оказанные услуги.
        /// </summary>
        // *** Start programmer edit section *** (ОказанныеУслуги.Договор CustomAttributes)

        // *** End programmer edit section *** (ОказанныеУслуги.Договор CustomAttributes)
        ...
        public virtual IIS.Modul_ucheta.Договор Договор
        {
            get
            {
                // *** Start programmer edit section *** (ОказанныеУслуги.Договор Get start)

                // *** End programmer edit section *** (ОказанныеУслуги.Договор Get start)
                IIS.Modul_ucheta.Договор result = this.fДоговор;
                // *** Start programmer edit section *** (ОказанныеУслуги.Договор Get end)

                // *** End programmer edit section *** (ОказанныеУслуги.Договор Get end)
                return result;
            }
            set
            {
                // *** Start programmer edit section *** (ОказанныеУслуги.Договор Set start)

                // *** End programmer edit section *** (ОказанныеУслуги.Договор Set start)
                this.fДоговор = value;
                // *** Start programmer edit section *** (ОказанныеУслуги.Договор Set end)

                // *** End programmer edit section *** (ОказанныеУслуги.Договор Set end)
            }
        }
