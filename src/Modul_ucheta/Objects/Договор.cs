...
namespace IIS.Modul_ucheta
{
    ...
    [View("ДоговорE", new string[] {
            ...
            "Директор as \'Фамилия директора\'",
            "Директор.Имя as \'Имя директора\'",
            "Директор.Отчество as \'Отчество директора\'",
            "Клиент as \'Фамилия клиента\'",
            "Клиент.Имя as \'Имя клиента\'",
            "Клиент.Отчество as \'Отчество клиента\'"})]
    [MasterViewDefineAttribute("ДоговорE", "Директор", ICSSoft.STORMNET.LookupTypeEnum.Standard, "", "Фамилия")]
    ...
    [View("ДоговорL", new string[] {
            ...
            "Длительность as \'Длительность\'",
            "ЕдиницаВремени as \'Единица времени\'",
            "Директор.Фамилия as \'Фамилия директора\'",
    ...
    public class Договор : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Modul_ucheta.Директор fДиректор;
        ...
        /// ЕдиницаВремени.
        /// </summary>
        // *** Start programmer edit section *** (Договор.ЕдиницаВремени CustomAttributes)

        // *** End programmer edit section *** (Договор.ЕдиницаВремени CustomAttributes)
        public virtual IIS.Modul_ucheta.ЕдиницаВремени ЕдиницаВремени
        {
            get
            {
                // *** Start programmer edit section *** (Договор.ЕдиницаВремени Get start)

                // *** End programmer edit section *** (Договор.ЕдиницаВремени Get start)
                IIS.Modul_ucheta.ЕдиницаВремени result = this.fЕдиницаВремени;
                // *** Start programmer edit section *** (Договор.ЕдиницаВремени Get end)

                // *** End programmer edit section *** (Договор.ЕдиницаВремени Get end)
                return result;
            }
            set
            {
                // *** Start programmer edit section *** (Договор.ЕдиницаВремени Set start)

                // *** End programmer edit section *** (Договор.ЕдиницаВремени Set start)
                this.fЕдиницаВремени = value;
                // *** Start programmer edit section *** (Договор.ЕдиницаВремени Set end)

                // *** End programmer edit section *** (Договор.ЕдиницаВремени Set end)
            }
        }
        ...
        /// Договор.
        /// </summary>
        // *** Start programmer edit section *** (Договор.Директор CustomAttributes)

        // *** End programmer edit section *** (Договор.Директор CustomAttributes)
        [PropertyStorage(new string[] {
                "Директор"})]
        [NotNull()]
        public virtual IIS.Modul_ucheta.Директор Директор
        {
            get
            {
                // *** Start programmer edit section *** (Договор.Директор Get start)

                // *** End programmer edit section *** (Договор.Директор Get start)
                IIS.Modul_ucheta.Директор result = this.fДиректор;
                // *** Start programmer edit section *** (Договор.Директор Get end)

                // *** End programmer edit section *** (Договор.Директор Get end)
                return result;
            }
            set
            {
                // *** Start programmer edit section *** (Договор.Директор Set start)

                // *** End programmer edit section *** (Договор.Директор Set start)
                this.fДиректор = value;
                // *** Start programmer edit section *** (Договор.Директор Set end)

                // *** End programmer edit section *** (Договор.Директор Set end)
            }
        }
